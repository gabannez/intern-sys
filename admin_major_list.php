...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$query = mysqli_query($con, "SELECT * FROM major WHERE appellation LIKE '%$searchtext%'");
		...
		<div id="container">
			...
			<table>
				...
				<?php
					$n = 0;
					$max = sizeOf($list);
					$query = mysqli_query($con, "SELECT id FROM major");
					while($n < $max) {
						...
						echo '<td align="center"><a href="admin_major_delete.php?del='.$id.'"><img src="images/delete.png" width="20" height="20" /> Delete</td>';
						echo '<tr></tr>';
						$n++;
					}
				?>
