...
$sql = "SELECT * FROM state WHERE id = '$id_edit'";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(empty($error)) {
		$sql = "UPDATE state SET appellation = '$appellation', DT_CREATE = NOW(), IDENT = '$user' WHERE id = '$id_edit'";
		$result = mysqli_query($con, $sql);
...
<body>
	<div id="SiteBody">
		...
		<div id="container">
			<form method="post" action="<?php echo "admin_state_update.php?edit=$id_edit"; ?>">
				<table>
					<th colspan = "4"><div><?php echo $message; ?></div>State Update Form</th>
					<tr>
						<td>Appellation: *</td>
