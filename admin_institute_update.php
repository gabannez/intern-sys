...
$sql = "SELECT * FROM institute WHERE id = '$id_edit'";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(empty($error)) {
		$sql = "UPDATE institute SET appellation = '$appellation', DT_CREATE = NOW(), IDENT = '$user' WHERE id = '$id_edit'";
		$result = mysqli_query($con, $sql);
...
<body>
	<div id="SiteBody">
		...
		<div id="nav-left">
				<a href="menu" class="link"><img src="/eintern/images/home.png" alt="home">
		...
		<div id="container">
			<form method="post" action="<?php echo "admin_institute_update.php?edit=$id_edit"; ?>">
				<table>
					<th colspan = "4"><div><?php echo $message; ?></div>Institute Update Form</th>
					<tr>
						<td>Appellation: *</td>
